...
o clasa de baza (parinte) si apoi clase copil, care sa mosteneasca parintele
si implicit toate atributele acestuia.

Mostenirea permite sa avem o ierarhie a claselor, cu oricate nivele dorim.
Se pot mosteni atat atributele, cat si metodele clasei parinte.
Clasa copil poate avea in plus fata de clasa parinte oricate atribute sau metode doreste.
In cazul metodelor, atunci cand avem in clasa copil o metoda exact ca si cea din clasa parinte,
zicem ca o suprascriem (overwrite) si TREBUIE sa fim atenti ca daca vrem sa beneficiem  si de ceea
ce se intampla in clasa parinte, sa o apelam cu super() => exemplu in constructor
"""
...
#Metodele specifice fiecarui copil, vor fi puse in clasa copil de care apartin a
